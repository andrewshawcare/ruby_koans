...
class AboutClassMethods < Neo::Koan
  ...
  #
  # self.method is explicit and is common across languages. class << self borrows from the convention of appending to
  # things, which can be nice when extending a class after it has been defined.
