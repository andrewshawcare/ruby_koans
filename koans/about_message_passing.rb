...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # It provides both for compatibility concerns. Ideally, only __send__ would exist, as send is a desirable name
    # and is likely to be overridden in classes, where __send__ is less likely. Thus, __send__ was added to the language
    # later and is the safer method to invoke when using send semantics to execute an instance method.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # We might allow the class to handle the missing method, but that seems horrible.
    #
    # NOTE:
    #
