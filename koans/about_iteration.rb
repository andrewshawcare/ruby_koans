...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Inject (also known as reduce) aggregates a collection by successively mapping over an aggregate value and elements
    # of the collection, returning the new aggregate value
  end
  ...
  #
  # By providing a block, we can ensure the file object will be closed when the block terminates.
