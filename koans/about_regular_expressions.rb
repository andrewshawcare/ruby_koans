...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #
    # * fails to match if you don't have a target (a character or character group before the *) or when there
    # is something that precedes the target that is not matched (e.g. ''[/ab*/]).
  end
  ...
  # Why?
  #
  # Since they will exhaust a set of characters that match the target for a potentially infinite sequence, it can be
  # considered that they are greedy in comparison to operators like ?, which only attempts to match an
  ...
  #
  # A character class represents a potential set of matches for every character
  # in the bounded sequence, where alternation represents a potential set of
  # matches for a group of strings that may appear in the bounded sequence
